...
def main(args):
    ...
    pipeline = Pipeline(path_model, device, with_sv=False)
    ...
    pipeline.wav2midi(src, args.output, None, silent=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "input", type=str, help="Path to the input wav file or URL of YouTube video"
    )
    parser.add_argument(
        "-o",
        "--output",
    ...
    parser.add_argument(
        ...
        type=str,
        default="level2",
        help="Cover style. Valid values are 'level1', 'level2', and 'level3'. Defaults to 'level2'",
    )
